package edu.sdccd.cisc191.Game.Riddles;
...
public class RiddlesGameScreen extends SceneController {
    ...
    public void createRiddleScreen() {
        ...
        ellipse.setFill(Color.valueOf("#738d6b"));
        ...
        polyline1.setFill(Color.valueOf("#2c2109"));
        polyline1.setLayoutX(784.0);
        polyline1.setLayoutY(517.0);
        polyline1.setStroke(Color.valueOf("#2c2109"));
        polyline1.setStrokeType(StrokeType.INSIDE);
        ...
        polyline2.setFill(Color.valueOf("#2c2109"));
        polyline2.setLayoutX(131.0);
        polyline2.setLayoutY(517.0);
        polyline2.setStroke(Color.valueOf("#2c2109"));

        polyline2.setStrokeType(StrokeType.INSIDE);
        ...
        circle.setFill(Color.valueOf("#575656"));
        circle.setStroke(Color.valueOf("#575656"));
